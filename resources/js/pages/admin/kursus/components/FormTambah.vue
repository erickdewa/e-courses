				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group" align="center">
							<div class="image-upload-box images" :style="`background-image: url(${formData.thumbnile}); background-size: contain; background-position: center center; width: 350px; height: 200px`">
