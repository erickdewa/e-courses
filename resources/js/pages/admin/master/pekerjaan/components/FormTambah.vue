				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="nm_pekerjaan" required v-model="formData.nm_pekerjaan" placeholder="Nama Pekerjaan">
						</div>
					</div>
				</div>
			</div>
    ...
    export default {
	    ...
	    methods: {
	    	simpanData(uuid){
	    		...
	    		var urls = `${ vm.apiUrl }/pekerjaan/create`;
	    		if(uuid != ''){
	    			urls = `${ vm.apiUrl }/pekerjaan/${ uuid }/update`;
	    		}
	    	...
	    	getData(uuid){
	    		...
	    		vm.$http({
	    			url: `${ vm.apiUrl }/pekerjaan/${ uuid }/getdata`,
	    			method: 'GET',
	    		}).then((res)=>{
