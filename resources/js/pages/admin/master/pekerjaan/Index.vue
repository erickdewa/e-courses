		...
		<transition enter-active-class="animated fadeIn">
			<div class="aro-restraint" v-if="showList">
				...
				<div class="aro-restraint_body">
					<AdminTable id="table" ref="table" classx="table table-rowed" :urls="'/pekerjaan/index'" :callbacks="callback()" :columns="columns"></AdminTable>
				</div>
			</div>
		</transition>
		...
		<transition enter-active-class="animated fadeIn">
			<div class="aro-restraint" v-if="showForm">
				<div class="aro-restraint_title">
					<span>Pekerjaan</span>
					<div class="button-table">
						<button type="button" class="btn btn-info btn-sm btn-submit" @click.prevent="showList = true; showForm = false">
    ...
    export default {
    	...
    	data() {
	        return {
	        	...
	        	columns: [
	        		{ name: 'Nama Pekerjaan', data: 'nm_pekerjaan' },
	    ...
	    methods: {
	    	...
	    	deleteData(uuid){
	    		...
	    		vm.$http({
	    			url: `${ vm.apiUrl }/pekerjaan/${ uuid }/delete`,
	    			method: 'DELETE',
	    		}).then((res)=>{
